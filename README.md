...
Nexora is maintained by **Godoy** and is distributed under the MIT License. It is a renamed and redesigned continuation of the MIT-licensed VCamdroid project; see [ATTRIBUTION.md](ATTRIBUTION.md).
