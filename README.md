...
Nexora is maintained by **Godoy** and distributed under the MIT License. It is a renamed and redesigned continuation of the MIT licensed VCamdroid project. The original authorship and third party notices are preserved in [ATTRIBUTION.md](ATTRIBUTION.md).
...
Windows 11, Linux Mint 22 and FreeBSD 15.1 have been tested manually, including WiFi and USB connections. Ubuntu 24.04 is validated by the automated build workflow. Arch Linux builds are validated automatically, and runtime operation has been confirmed through community testing on CachyOS.
...
1. Download the Arch Linux package from the latest release.
...
The package detects the standard Arch, LTS, Zen and Hardened kernels and configures `/dev/video10`. Runtime operation has been confirmed on CachyOS. See [archlinux/README.md](archlinux/README.md) for details.
...
GitHub Actions builds Android, Windows, Linux, FreeBSD and Arch Linux automatically. Local build instructions are available in [docs/BUILDING.md](docs/BUILDING.md).
...
<p>
  ...
  <strong>Arch Linux:</strong> <code>windows/CMakeLists.txt</code> and <code>archlinux/</code><br>
...
Nexora modifications: Copyright © 2026 Godoy.
