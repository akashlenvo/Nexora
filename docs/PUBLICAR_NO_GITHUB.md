...
Não remova a linha de copyright do autor original. A licença MIT permite modificar e redistribuir, mas exige que o aviso original e o texto da licença acompanhem cópias substanciais. A sua linha, `Copyright (c) 2026 Godoy (Nexora modifications)`, já foi acrescentada.
